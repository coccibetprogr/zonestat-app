...
export default async function AccountPage() {
  ...
  const { data: profile, error: profileError } = await supabase
    .from("profiles")
    // ⬇️ on ajoute free_until ici
    .select("stripe_customer_id, stripe_subscription_status, free_until")
    .eq("id", user.id)
    .maybeSingle();
  ...
  if (isFreeTrial && !hasAnySubscription) {
    statusLabel = "Essai gratuit en cours";
    variant = "success";
    hasAnySubscription = true;
  }
  // --- fin logique essai gratuit ---
